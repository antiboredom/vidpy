...
class TestComposition(unittest.TestCase):
    ...
    def test_basic_singletrack_composition(self):
        ...
        self.assertEqual(str(comp), 'melt -track color:#000000 out=0 -track video.mp4 in=":0.000000" video2.mp4 in=":0.000000" -transition composite distort=0 a_track=0 b_track=1')
    ...
    def test_basic_multitrack_composition(self):
        ...
        self.assertEqual(str(comp), 'melt -track color:#000000 out=0 -track video.mp4 in=":0.000000" -transition composite distort=0 a_track=0 b_track=1 -transition mix a_track=0 b_track=1')
    ...
    def test_multitrack_composition(self):
        ...
        self.assertEqual(str(comp), 'melt -track color:#000000 out=0 -track video.mp4 in=":0.000000" -track video2.mp4 in=":0.000000" -transition composite distort=0 a_track=0 b_track=1 -transition mix a_track=0 b_track=1 -transition composite distort=0 a_track=0 b_track=2 -transition mix a_track=0 b_track=2')
